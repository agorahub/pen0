---
layout: post
title : Defense-Critical Energy Infra.
author: Joseph Majkut, et al.
date  : 2026-03-17 12:00:00 +0800
image : https://i.imgur.com/2GmEvRU.jpeg
#image_caption: ""
description: "Energy Infrastructure and the Defense Industrial Base"
excerpt_separator: <excerpt/>
---

_Can the energy infrastructure serving the U.S. defense industrial base sustain production under mobilization?_ <excerpt/> _This paper focuses on three scenarios for mobilization consistent with baseline production, defense buildup, and peer war. Using embodied energy methods, the research team estimates that war production rates would require 17.4 petajoules (PJ) of energy annually, a relatively small amount nationally, but one that would need to be concentrated at facilities in already stressed grid regions. Facilities for the defense-critical production of steel, aluminum, titanium, and semiconductors are clustered in regions already facing eroding reserve margins and surging data center demands. Natural gas deliverability constraints compound these risks, as key facilities depend on gas both as direct fuel and as the primary source of regional electricity generation. This paper recommends extending defense-critical electric infrastructure designations to industrial nodes, creating dedicated permitting and finance pathways to facilitate energy production, and integrating energy resilience into supply chain risk assessments._
...
![image01](https://i.imgur.com/klHzmQE.png)
_▲ Table 1: Select Annual Defense Production Levels by Scenario_
...
![image02](https://i.imgur.com/8YM43Bf.png)
_▲ FIGURE 1A: Estimated Annual Embodied Energy by Defense System_

![image03](https://i.imgur.com/Fqp6gXP.png)
_▲ FIGURE 1B: Estimated Annual Embodied Energy vs. Total U.S. Energy Use_
...
![image04](https://i.imgur.com/ohqNIPA.png)
_▲ FIGURE 2: Embodied Energy by Material Across Mobilization Scenarios_
...
![image05](https://i.imgur.com/FtEieNs.png)
_▲ __FIGURE 3: Distribution of Critical Industrial Facilities by Sector.__ Symbol size represents facility capacity._

![image06](https://i.imgur.com/LJL83vn.png)
_▲ __FIGURE 4: Winter Gas Price Volatility by Sector.__ Note: Color represents county-level power system vulnerability (PSVI)._
...
![image07](https://i.imgur.com/Dp1sc8c.png)
_▲ FIGURE 5: Distribution of Critical Industrial Capacity in PJM_
...
![image08](https://i.imgur.com/h16oKlI.png)
_▲ FIGURE 6: Critical Industrial Capacity Exposure to Winter Gas-Price Volatility_
...
![image09](https://i.imgur.com/VHeViF4.png)
_▲ FIGURE 7: Critical Industry Facility Distribution Exposure Risks Facility Distribution at the County (PSVI) and State Levels (Winter Gas Price Volatility)_
...
![image10](https://i.imgur.com/XFsNVeI.png)
_▲ Table 2: Overall Energy Infrastructure Exposure by Sector_
...
![image11](https://i.imgur.com/lT97ll9.png)
_▲ __FIGURE 8: Planned Data Center Development and Critical Industry Concentration by Region.__ Source: Michael Thomas, [“Data Centers in the United States,”](https://cleanview.co/public/data-centers/us) Cleanview, updated March 2026; and [“Dec 09, 2025 Board of Directors Meeting,”](https://ercot.new.swagit.com/videos/363073) ERCOT, December 9, 2025._
...
![image12](https://i.imgur.com/nw213Wp.png)
_▲ Table A-1: Material Embodied Energy (EE), Sources, and Assumptions_

![image13](https://i.imgur.com/kmXdlaN.png)
_▲ Table A-2: Mobilization Scenario Rates by Defense System_
...
_LONG-RANGE PRECISION MUNITIONS_
...
__Alexander Palmer__ is a fellow with the Warfare, Irregular Threats, and Terrorism (WITT) Program at CSIS.

__Raj Sawhney__ is an adjunct fellow (non-resident) with the Energy Security and Climate Change Program at CSIS.
